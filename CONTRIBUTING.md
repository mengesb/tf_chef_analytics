Contributing to tf_chef_analytics
=================================
...
Familiarize yourself with Chef and the operation of the chef-analytics cookbook

- [chef-server](https://github.com/chef-cookbooks/chef-analytics) cookbook
